          ...
          <?php
            ...
            foreach ($bayar as $key => $value) { ?>
              <tr>
                ...
                <td><?php echo $value['pembayar_tgl'] ?></td>
                <td><?php echo $value['pembayar_jumlah'] ?></td>
                <td>
                  <a class="btn btn-info" style="color:white;" data-toggle="modal" data-target="#exampleModal1<?php echo $value['pembayar_id'];?>">Edit </a>
                  <a href="<?php echo base_url('bayar/delete/'.$value['pembayar_id']); ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Hapus</a>
                </td>
              </tr>
          <?php $no++;
        }?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation" novalidate="" action="<?php echo base_url('bayar/tambah') ?>" method="post">
            ...
            <div class="input-group">
              ...
              <select class="form-control" name="donaturTanggung" required>
                ...
                <?php foreach ($tanggungan as $key => $value): ?>
                  <option value="<?php echo $value['tanggungan_id'] ?>"><?php echo $value['donatur_nama'] ?></option>
                <?php endforeach; ?>
              </select>
